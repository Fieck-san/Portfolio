...
const allProjects = [
  {
    id: 1,
    title: 'TaskFlow AI',
    description: 'AI-powered project management dashboard with enterprise-ready capabilities and modern UI.',
  ...
  },
  {
    id: 2,
    title: 'CodeReview AI',
    description: 'Intelligent code analysis platform with AI-powered suggestions and team collaboration.',
    image: '/projects/codereview-ai.jpg',
  ...
  },
  {
    ...
    description: 'Complete booking system with dual interfaces for businesses and customers.',
